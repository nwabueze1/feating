...
export var euReducer = function (state, action) {
    var _a;
    switch (action.type) {
        case "SET_LOADING":
            return __assign(__assign({}, state), { loading: action.payload });
        case "GET_MENU_ITEMS":
            return __assign(__assign({}, state), { restaurant: { menu: __assign(__assign({}, (_a = state.restaurant) === null || _a === void 0 ? void 0 : _a.menu), { menuItems: action.payload }) } });
        case "GET_EAT_UP":
...
export var store = function () {
    return createStore(euReducer, {
        gatewayUrl: "https://ploutonion.sytbuilder.com/graphql",
        colors: __assign({}, Palettes.palette11.colors),
        fonts: {
            heading: "Montserrat",
            body: "Poppins",
            misc: "Lobster",
            ...
            cart: {
                ...
                cartItems: [
                    ...
                    },
                    {
                        ...
                        options: '[{"name":"Meat","type":"extras","selectedChoices":[{"name":"Goat Meat","amount":"6"},{"name":"Asun","amount":"4"},{"name":"Cow meat","amount":"3"}]},{"name":"Dinks","type":"selection","selectedChoices":[{"name":"Fanta","amount":"1"}]}]',
                        quantity: 2,
                ...
                menuItems: [
                    {
                        ...
                        image: {
                            ...
                            height: 600,
                            source: "https://unsplash.com",
                            original: "https://images.unsplash.com/photo-1610631087218-f784839e48f1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1NTQ4ODJ8MHwxfHNlYXJjaHw0fHxZYW18ZW58MHx8fHwxNzE2MzkxODIyfDA&ixlib=rb-4.0.3&q=80&w=400",
                            __typename: "ExternalImage",
                            screenType: "desktop",
                            coordinates: {
                                mobile: {
            ...
            posts: [
                {
                    ...
                    featured_image: {
                        ...
                        width: 400,
                        height: 331,
                        original: "https://images.unsplash.com/photo-1713727967827-b04e5eab7d3a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1NTQ4ODJ8MHwxfHJhbmRvbXx8fHx8fHx8fDE3MTYzMDAzNzh8&ixlib=rb-4.0.3&q=80&w=400",
                    },
                ...
                },
                {
                    ...
                    featured_image: {
                        ...
                        width: 400,
                        height: 600,
                        original: "https://images.unsplash.com/photo-1714423647936-6f31729c3dd0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1NTQ4ODJ8MHwxfHJhbmRvbXx8fHx8fHx8fDE3MTYzMDAyNjh8&ixlib=rb-4.0.3&q=80&w=400",
                    },
                    excerpt: "Halellujah",
                ...
                },
                {
                    ...
                    featured_image: {
                        ...
                        width: 400,
                        height: 643,
                        original: "https://images.unsplash.com/photo-1714659784722-1b8d820e2174?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1NTQ4ODJ8MHwxfHJhbmRvbXx8fHx8fHx8fDE3MTYzMDAyNjh8&ixlib=rb-4.0.3&q=80&w=400",
                    },
                ...
                },
                {
                    ...
                    featured_image: {
                        ...
                        width: 400,
                        height: 267,
                        original: "https://images.unsplash.com/photo-1713894708806-bc01a6bed8e3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1NTQ4ODJ8MHwxfHJhbmRvbXx8fHx8fHx8fDE3MTYzMDAxOTN8&ixlib=rb-4.0.3&q=80&w=400",
                    },
                    excerpt: "splits",
