...
import { Dialog } from "@wazobia-tech/wazcom/dist/core";
import { AiOutlineClose } from "react-icons/ai";
import { usePluginFormNotificationStyles } from "./usePluginFormNotificationStyles";

export const PluginFormNotification: FC<PluginFormNotificationPropsType> = ({ open, message_type, message, onClose, colors }) => {
  const classes = usePluginFormNotificationStyles();
